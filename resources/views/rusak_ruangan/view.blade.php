...
{{-- atur baris --}}
 <div class="row"> 
   {{-- buat kotak total jumlah barang rusak diruangan --}}
      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            ...
            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$rusak_ruangan}}</div>
          </div>
          <div class="col-auto">
...
{{-- atur body dan tabel agar responsive --}}
<div class="card-body">
...
{{-- tampilkan data dalam tabel dengan ajax --}}
   <script>
 $(document).ready( function () {
    $('#example').DataTable({
           processing: true,
           serverSide: true,
           ajax: "/rusak_ruangan_json",
           columns: [
                    { data: 'nama', name: 'nama' },
