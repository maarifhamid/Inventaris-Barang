...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="lap_rusak_dalam_input" method="post">
            @csrf
            <div class="row">
                <div class="col-md-4">
...
<div class="card shadow mb-4">
<div class="card-header py-3">
  <h6 class="m-0 font-weight-bold text-dark">Laporan Barang Rusak Dalam Ruangan</h6>
</div>
<div class="card-body">
  <div class="table-responsive">
    ...
    <form action="/lap_rusak_dalam/export_excel">
    ...
    @endif
       <br>
    @include('laporan.table_rusak_dalam', $rusak_dalam )
  </div>
</div>
