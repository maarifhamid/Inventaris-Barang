...
<title>Data User Pj Ruangan </title>
<div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-dark">Data User Pj Ruangan </h6>
</div>
<div class="card-body">
        ...
        <table id="dataTable" class="table table-bordered" cellspacing="0">
            ...
            <tbody>
                ...
                <tr class="data-row">
                    ...
                    <td>
                        <div class="row">
                                <a href="/bukan_pj/edit/{{ $u->id }}" class="btn btn-primary btn-sm ml-2">Edit</a>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/store_bukan_pj" method="post">
                    @csrf
                    ...
                    <input type="hidden" name="level" value="bukan_pj">
