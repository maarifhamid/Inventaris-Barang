...
{{-- atur baris --}}
 <div class="row"> 
   {{-- atur kotak total jumlah barang ruangan --}}
...
<div id="tambah" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
      ...
      <div class="modal-content">
        ...
        <form action="/input_ruangan/store" method="post" enctype="multipart/form-data">
            @csrf
          ...
          <div class="form-group">
           ...
           <div class="form-group">
                ...
                <input type="date" name="tanggal_masuk" class="form-control" placeholder="Masukan Tanggal Masuk" required>
            </div>
